    ...
    with container:
        ...
        with img_view_col1:
            if st.session_state.widemode:
                ...
                st.image(image, caption=filename, use_column_width=True) # Use column width to fit the image to the browser window
        with img_view_col2:
            ...
            with subcol1:
                metricview = st.metric(label="Rating", value=st.session_state.rating)
