...
with st.container():
    ...
    with col2:
        st.info(
            "When you click on an image, that image is set as the active image in the image viewer. This means you can either click the button above or just click on '🖼️Image viewer' in the sidebar"
        )
